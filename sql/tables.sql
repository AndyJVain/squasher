...
create table squasher_reports(
	...
	STATE VARCHAR(50) check(UPPER(STATE) in ('PENDING BUG VERIFICATION','BUG VERIFICATION FAILED','PENDING DEVELOPER ASSIGNMENT','PENDING FIX DEVELOPMENT','PENDING FIX VERIFICATION','PENDING DEPLOYMENT','DONE')) NOT NULL,
